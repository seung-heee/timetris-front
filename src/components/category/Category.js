...
const Category = ({isOpen, setIsOpen, openModalHandler}) => {
        ...
        <div className='w-[500px] h-[236px] bg-[#F6F6F6] rounded-md p-5'>
            ...
            <div className='flex justify-between items-center'>
                <div className='flex items-center'>
                    <span>나의 카테고리</span>
                    <button onClick={openModalHandler} className='addDiamond origin-center rotate-45 w-[11px] h-[11px] bg-[#888888] ml-2'></button>
                </div>
