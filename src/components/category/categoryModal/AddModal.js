...
const AddModal = () => {
    ...
    return (
        <>
        <button onClick={openModalHandler}>카테고리 추가하기</button>
        {isOpen ? 
            <button onClick={openModalHandler} className='fixed z-10 flex justify-center items-center bg-[rgba(0,0,0,0.4)] rounded-[10px] top-0 left-0 right-0 bottom-0'>
